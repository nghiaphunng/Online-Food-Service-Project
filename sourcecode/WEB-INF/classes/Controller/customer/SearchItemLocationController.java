...
@WebServlet("/SearchItemLocationController")
public class SearchItemLocationController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public SearchItemLocationController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Item> itemList = ItemDAO.SearchItemByLocation(request, conn, location, typeItem);
        //đóng cổng kết nối
        try {
			conn.close();
