...
public class UpdateItemController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int checkUpdateItemId = WarehouseDAO.UpdateItemId(conn , itemId, nameItem, priceItem, quantityItem, desItem, desSearchItem);
		...
		try {
			...
			ErrorDAO.insertError(conn, "Error Closing Connection(UpdateItemController)", e.getMessage());
		}
	}
