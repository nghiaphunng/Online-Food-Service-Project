...
@WebServlet("/DeleteRestaurantIdController")
public class DeleteRestaurantIdController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DeleteRestaurantIdController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminDAO.deleteRestaurantId(conn, RestaurantId);
	    ...
	    try {
			...
			ErrorDAO.insertError(conn, "Error Closing Connection(DeleteRestaurantIdController)", e.getMessage());
		}
	}
