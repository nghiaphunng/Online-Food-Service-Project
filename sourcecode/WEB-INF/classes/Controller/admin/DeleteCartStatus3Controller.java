...
@WebServlet("/DeleteCartStatus3Controller")
public class DeleteCartStatus3Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DeleteCartStatus3Controller() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminDAO.deleteCartStatus3UserId(conn, userId);
	    ...
	    try {
			...
			ErrorDAO.insertError(conn, "Error Closing Connection(DeleteCartStatus3Controller)", e.getMessage());
		}
	}
